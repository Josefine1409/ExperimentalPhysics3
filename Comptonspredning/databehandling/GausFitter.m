...
names = {'Co60','Cs137'};
fileID = fopen(filenames{1},'r');
peakValues = {[1.1732,1.3325],[0.6617]}
data = [];
for i = 1:length(filenames)
    data = [data, fitGaussInSpectrum(filenames{i},names{i},peakValues{i})]
end
figure
xlabel('Channel')
ylabel('Energy')
...
function data = fitGaussInSpectrum(filename,name,peakValue)
