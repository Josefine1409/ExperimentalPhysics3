...
plot(Es,linFun(beta,Es),'r','linewidth',1)
...
[beta,R,J,CovB,MSE,ErrorModelInfo] = nlinfit(x,y,@(beta,x) linFun(beta,x),beta0,'weights',w);
hold on
plot(Es,linFun(beta,Es),'b','linewidth',1)
...
[beta,R,J,CovB,MSE,ErrorModelInfo] = nlinfit(x,y,@(beta,x) linFun(beta,x),beta0,'weights',w);
hold on
plot(Es,linFun(beta,Es),'c','linewidth',1)
...
legend('Data 1. day','Fit 1. day','Data 2. day','Fit 2. day','Data 3. day','Fit 3. day','Location','northwest')
