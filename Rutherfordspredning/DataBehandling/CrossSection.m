...
peakBorders = {[380,480],     [380,490],     [380,480],     [350,460],     [340,460],     [340,455],     [310,455],     [300,455],     [280,455],     [280,455],     [280,455],     [280,455]};
...
beta0 = [0,0,y(round(peakChannel(1))==x),peakChannel(1),10,y(round(peakChannel(2))==x),peakChannel(2),10];
...
plot(x,beta(1).*x+beta(2)+beta(3).*exp(-((x-beta(4))./(beta(5))).^2./2),'--')
plot(x,beta(1).*x+beta(2)+beta(6).*exp(-((x-beta(7))./(beta(8))).^2./2),'--')
...
function y = fitfunction(beta,x)
    y = beta(1).*x+beta(2)+beta(3).*exp(-((x-beta(4))./(beta(5))).^2./2)+beta(6).*exp(-((x-beta(7))./(beta(8))).^2./2);
    y =y';
end