function Spectrum = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   SPECTRUM = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   SPECTRUM = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Spectrum = importfile('30degree.asc',10, 16393);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/10/09 10:12:40
